...
export default class ContextPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        ...
        addIconsToSearchPath(window, this.dir);

        const params = { window, metadata, settings, defaults };
        window.add(new PanelPreferences(params));
        window.add(new LockPreferences(params));
        window.add(new AdvancedPreferences(params));
    }
}
